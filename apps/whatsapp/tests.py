...
class IndexRouteTests(TestCase):
    ...
    def test_anonymous_redirects_to_login(self):
        response = self.client.get(reverse("whatsapp:index"))
        self.assertRedirects(response, f"{reverse('account_login')}?next={reverse('whatsapp:index')}")
    ...
    def test_authenticated_renders_shell(self):
        ...
        self.assertContains(response, "WhatsApp Accounts")
